    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        b.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                int cal8=30*Integer.parseInt(et14.getText().toString());
                int cal=cal1+cal2+cal3+cal4+cal5+cal6+cal7+cal8;
                total=cal+"";
                Intent i=new Intent(getBaseContext(),intake.class);
                i.putExtra("taken",total);
                startActivity(i);
                Toast.makeText(getBaseContext(),total+" CALORIES TODAY",Toast.LENGTH_LONG).show();
            }
        });
